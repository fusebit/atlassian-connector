        ...
        files: {
          ...
          'package.json': {
            ...
            dependencies: {
              ...
              superagent: '6.1.0',
              // Parse any additional dependencies specified in the configuration.
              ...configuration.fusebit_additional_imports.split(',').reduce((acc, imp) => {
                const idx = imp.lastIndexOf('@');
                acc[imp.substring(0, idx)] = imp.substring(idx + 1);
                return acc;
              }, {}),
            },
          },
